...
func set_signing_key{
        ...
        range_check_ptr}(new_signing_key : felt) -> ():
    # get the signature
    ...
    verify_ecdsa_signature(
        message=hash, public_key=signing_key, signature_r=sig[0], signature_s=sig[1])
    # set the new key
...
@view
func get_signing_key{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (
        signing_key : felt):
    let (signing_key) = _signing_key.read()
